                    ...
                    <div class='col-md-12'>
                        <div class='row'>
                            <div class='col-md-12'>
                                ...
                                <div class='col-md-12 vol'>Volunteer</div>
                                <div class=' pb-4 col-md-12 vol '>{{$volunteer->email}}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section>
                <div class="container cityFilter my-5">
                    <div class="row ">
                        <div class='col-md-6 p-5'>
                            ...
                            <div class='row'>
                                <form action='/cityNGOsV' method="post">
                                    @CSRF
                ...
                <div class='container my-3'>
                    <div class="card">
                        <div class="row card1">
                            <div class="col-md-5">
                                <img src="{{asset('img/NGOs/'.$donation->image)}}" class="img-fluid rounded-start"
                                    alt="...">
                            </div>
                            <div class="col-md-6">
